...
function drawBackground() {
    ...
    // Sun
    ctx1.beginPath();
    ctx1.arc(canvas1.width - 200, 100, 50, 0, Math.PI * 2);
...
function drawHouse() {
    ...
    ctx1.fillRect(850, 309, 200, 150);

    // Roof
    ctx1.beginPath();
    ctx1.moveTo(850, 310);
    ctx1.lineTo(950, 210);
    ctx1.lineTo(1050, 310);
    ctx1.closePath();
    ...
    // Door
    ctx1.fillStyle = '#7e3517';
    ctx1.fillRect(920, 360, 60, 100);

    // Windows
    ctx1.fillStyle = '#faf884';
    ctx1.fillRect(990, 340, 50, 50);
    ctx1.fillRect(860, 340, 50, 50);
}
let i = 0;
function moveClouds() {
...
function drawTree() {
    ...
    ctx.fillRect(710, 360, 40, 100);

    // Leaves
    ctx.beginPath();
    ctx.arc(705, 330, 80, 0, Math.PI * 2);
    ctx.fillStyle = '#3A5F0B';
    ctx.fill();
    ctx.beginPath();
    ctx.arc(738, 240, 80, 0, Math.PI * 2);
    ctx.fillStyle = '#3A5F0B';
    ctx.fill();
    ctx.beginPath();
    ctx.arc(770, 330, 80, 0, Math.PI * 2);
    ctx.fillStyle = '#3A5F0B';
    ctx.fill();
}
function drawTree2() {
    // Trunk
    ctx.fillStyle = '#8B4513';
    ctx.fillRect(1370, 360, 20, 100);

    // Leaves
    ctx.beginPath();
    ctx.arc(1350, 370, 50, 0, Math.PI * 2);
    ctx.fillStyle = '#3A5F0B';
    ctx.fill();
    ctx.beginPath();
    ctx.arc(1383, 310, 60, 0, Math.PI * 2);
    ctx.fillStyle = '#3A5F0B';
    ctx.fill();
    ctx.beginPath();
    ctx.arc(1415, 370, 50, 0, Math.PI * 2);
    ctx.fillStyle = '#3A5F0B';
    ctx.fill();
}
function drawlamp() {
    ctx.beginPath();
    ctx.rect(40, 159, 10, 300); // x, y, width, height
    ctx.fillStyle = 'gray';
    ctx.fill();

    // Draw the lamp head
    ctx.beginPath();
    ctx.arc(46, 170, 20, 0, Math.PI, true); // x, y, radius, startAngle, endAngle, counterclockwise
    ctx.closePath();
    ctx.fillStyle = 'black';
    ctx.fill();
    ...
    // Draw the light
    ctx.beginPath();
    ctx.arc(46, 170, 10, 0, 2 * Math.PI); // smaller circle for light
    ctx.fillStyle = 'yellow';
    ctx.fill();
}
function drawlamp2() {
    ctx.beginPath();
    ctx.rect(1090, 159, 10, 300); // x, y, width, height
    ctx.fillStyle = 'gray';
    ctx.fill();

    // Draw the lamp head
    ctx.beginPath();
    ctx.arc(1096, 170, 20, 0, Math.PI, true); // x, y, radius, startAngle, endAngle, counterclockwise
    ctx.closePath();
    ctx.fillStyle = 'black';
    ctx.fill();
    ...
    // Draw the light
    ctx.beginPath();
    ctx.arc(1096, 170, 10, 0, 2 * Math.PI); // smaller circle for light
    ctx.fillStyle = 'yellow';
    ctx.fill();
}
